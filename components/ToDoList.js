...
class TodoList extends Component {
  constructor() {
    ...
    this.state = {
      // todoItems: ["Make a todo list of all my todo lists", "Make a playlist for every possible occasion", "Stop checking phone compulsively"],
      inputtedItem : ''
    }
  ...
  submitForm(event) {
    ...
    //   this.state.todoItems.push(inputtedItem.value);
    //   return {todoItems: state.todoItems, inputtedItem: ''};
    // });
    
    addToDoItem(inputtedItem.value)
  }
